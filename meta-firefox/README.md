...
| Kirkstone - 127.0     | ![kirkstone-arm-latest](https://github.com/OldManYellsAtCloud/meta-browser/actions/workflows/kirkstone-arm-v127.0.yml/badge.svg) | ![kirkstone-aarch64-latest](https://github.com/OldManYellsAtCloud/meta-browser/actions/workflows/kirkstone-aarch64-v127.0.yml/badge.svg) | ![kirkstone-x86_64-latest](https://github.com/OldManYellsAtCloud/meta-browser/actions/workflows/kirkstone-x86_64-v127.0.yml/badge.svg) | - |
...
| Scarthgap - 127.0     | ![scarthgap-arm-latest](https://github.com/OldManYellsAtCloud/meta-browser/actions/workflows/scarthgap-arm-v127.0.yml/badge.svg) | ![scarthgap-aarch64-latest](https://github.com/OldManYellsAtCloud/meta-browser/actions/workflows/scarthgap-aarch64-v127.0.yml/badge.svg) | ![scarthgap-x86_64-latest](https://github.com/OldManYellsAtCloud/meta-browser/actions/workflows/scarthgap-x86_64-v127.0.yml/badge.svg) | ![scarthgap-riscv-latest](https://github.com/OldManYellsAtCloud/meta-browser/actions/workflows/scarthgap-riscv-v127.0.yml/badge.svg) |
...
| 127.0 | application-services | e0563d725f852f617878ecc13a03cdf50c85cd5a | This involves a collection of crates developed by Mozilla. These are specified in the top level Cargo.toml, by explicit hash. (interrupt-support, sql-support, sync15, tabs, viaduct, webext-storage, suggest, relevancy) |
| 127.0 | cose-rust | 43c22248d136c8b38fe42ea709d08da6355cf04b | This commit is required explicitly by the top level Cargo.toml |
| 127.0 | mp4parse | a138e40ec1c603615873e524b5b22e11c0ec4820 | This commit is required explicitly by `toolkit/library/rust/shared/Cargo.toml` |
| 127.0 | neqo | 343df5cc0d02e0b0953de4a0a390ae8980d89081 | This commit corresponds to v0.7.7, which is required by `netwerk/socket/neqo_glue/Cargo.toml` |
| 127.0 | wgpu | d5d683d3c491ec8cd2f5cdb43ac61e526cb7c231 | This commit is required explicitly by `gfx/wgpu_bindings/Cargo.toml` |
| 127.0 | audioipc | 409e11f8de6288e9ddfe269654523735302e59e6 | This commit is required explicitly by `toolkit/library/rust/shared/Cargo.toml` |
| 127.0 | wpf-gpu-raster | 99979da091fd58fba8477e7fcdf5ec0727102916 | This commit is required explicitly by `toolkit/library/rust/shared/Cargo.toml` |
| 127.0 | warp | 9d081461ae1167eb321585ce424f4fef6cf0092b | This commit is required explicitly by the top level Cargo.toml |
| 127.0 | cubeb-pulse | 8ff972c8e2ec1782ff262ac4071c0415e69b1367 | This commit is required explicitly by `toolkit/library/rust/shared/Cargo.toml` |
| 127.0 | cubeb-coreaudio | 4ca174cf83ebe32b3198478c2211d69678845bc7 | Required explicitly by `./toolkit/library/rust/shared/Cargo.toml`. |
| 127.0 | midir | 85156e360a37d851734118104619f86bd18e94c6 | This commit is required explicitly by the top level Cargo.toml |
| 127.0 | aa-stroke | d94278ed9c7020f50232689a26d1277eb0eb74d2 | Required explicitly by `./toolkit/library/rust/shared/Cargo.toml`. |
| 127.0 | jsparagus | 61f399c53a641ebd3077c1f39f054f6d396a633c | Required explicitly by `js/src/frontend/smoosh/Cargo.toml`.|
| 127.0 | mio | 9a2ef335c366044ffe73b1c4acabe50a1daefe05 | This commit is required explicitly by the top level Cargo.toml |
| 127.0 | unicode-bidi | ca612daf1c08c53abe07327cb3e6ef6e0a760f0c | Specified in top level Cargo.toml, by explicit hash. |
| 127.0 | gpu-descriptor | 7b71a4e47c81903ad75e2c53deb5ab1310f6ff4d | Specified in top level Cargo.toml, by explicit hash. |
| 127.0 | any-all-workaround | 7fb1b7034c9f172aade21ee1c8554e8d8a48af80 | Specified in top level Cargo.toml, by explicit hash. |
