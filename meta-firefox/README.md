...
| Kirkstone - 126.0     | ![kirkstone-arm-latest](https://github.com/OldManYellsAtCloud/meta-browser/actions/workflows/kirkstone-arm-v126.0.yml/badge.svg) | ![kirkstone-aarch64-latest](https://github.com/OldManYellsAtCloud/meta-browser/actions/workflows/kirkstone-aarch64-v126.0.yml/badge.svg) | ![kirkstone-x86_64-latest](https://github.com/OldManYellsAtCloud/meta-browser/actions/workflows/kirkstone-x86_64-v126.0.yml/badge.svg) | - |
...
| Nanbield - 126.0      | ![nanbield-arm-latest](https://github.com/OldManYellsAtCloud/meta-browser/actions/workflows/nanbield-arm-v126.0.yml/badge.svg) | ![nanbield-aarch64-latest](https://github.com/OldManYellsAtCloud/meta-browser/actions/workflows/nanbield-aarch64-v126.0.yml/badge.svg) | ![nanbield-x86_64-latest](https://github.com/OldManYellsAtCloud/meta-browser/actions/workflows/nanbield-x86_64-v126.0.yml/badge.svg) | ![nanbield-riscv-latest](https://github.com/OldManYellsAtCloud/meta-browser/actions/workflows/nanbield-riscv-v126.0.yml/badge.svg)
...
| Scarthgap - 126.0     | ![scarthgap-arm-latest](https://github.com/OldManYellsAtCloud/meta-browser/actions/workflows/scarthgap-arm-v126.0.yml/badge.svg) | ![scarthgap-aarch64-latest](https://github.com/OldManYellsAtCloud/meta-browser/actions/workflows/scarthgap-aarch64-v126.0.yml/badge.svg) | ![scarthgap-x86_64-latest](https://github.com/OldManYellsAtCloud/meta-browser/actions/workflows/scarthgap-x86_64-v126.0.yml/badge.svg) | ![scarthgap-riscv-latest](https://github.com/OldManYellsAtCloud/meta-browser/actions/workflows/scarthgap-riscv-v126.0.yml/badge.svg) |
...
| 126.0 | application-services | e6ccfed09ebe663f464a33968f42e656c152e584 | This involves a collection of crates developed by Mozilla. These are specified in the top level Cargo.toml, by explicit hash. (interrupt-support, sql-support, sync15, tabs, viaduct, webext-storage, suggest, relevancy) |
| 126.0 | cose-rust | 43c22248d136c8b38fe42ea709d08da6355cf04b | This commit is required explicitly by the top level Cargo.toml |
| 126.0 | minidump-writer | 99c561931fe8cf1fa2135b3f23ff6588bef8fd1e | This commit corresponds to version 0.8.3, which is a dependency of `toolkit/crashreporter/rust_minidump_writer_linux/Cargo.toml` |
| 126.0 | minidump-common | c3de84b061339c686a572fb9f059e7ba3fad38d6 | This commit corresponds to version 1.19.1, which is specified by `third_party/rust/minidump-writer/Cargo.toml` |
| 126.0 | packed-simd | d938e39bee9bc5c222f5f2f2a0df9e53b5ce36ae | This commit corresponds to v0.3.9, which is required by `./third_party/rust/encoding_rs/Cargo.toml`. |
| 126.0 | mp4parse | a138e40ec1c603615873e524b5b22e11c0ec4820 | This commit is required explicitly by `toolkit/library/rust/shared/Cargo.toml` |
| 126.0 | neqo | c004359a817ffdea33394e94944d2f882e7e78af | This commit corresponds to v0.7.5, which is required by `netwerk/socket/neqo_glue/Cargo.toml` |
| 126.0 | wgpu | 0c5bebca514eb06d9387f87666c1c658f3f673b4 | This commit is required explicitly by `gfx/wgpu_bindings/Cargo.toml` |
| 126.0 | uniffi-rs | 0ecafdc06799205caf1432b93787a9c1f810a168 | This commit corresponds to v0.27.1, which is referred by the top level Cargo.toml. |
| 126.0 | metal | f507da4686234e658f31de54d2aa0dfa8abd236b | This is version v0.27.0, which is required by `wgpu-hal` (above) |
| 126.0 | cssparser | aaa966d9d6ae70c4b8a62bb5e3a14c068bb7dff0 | This commit is required explicitly by the top level Cargo.toml |
| 126.0 | audioipc | 409e11f8de6288e9ddfe269654523735302e59e6 | This commit is required explicitly by `toolkit/library/rust/shared/Cargo.toml` |
| 126.0 | wpf-gpu-raster | 99979da091fd58fba8477e7fcdf5ec0727102916 | This commit is required explicitly by `toolkit/library/rust/shared/Cargo.toml` |
| 126.0 | warp | 9d081461ae1167eb321585ce424f4fef6cf0092b | This commit is required explicitly by the top level Cargo.toml |
| 126.0 | cubeb-pulse | 8ff972c8e2ec1782ff262ac4071c0415e69b1367 | This commit is required explicitly by `toolkit/library/rust/shared/Cargo.toml` |
| 126.0 | cubeb-coreaudio | cc58f92f28015e4e25eba9e482007cf464c10474 | Required explicitly by `./toolkit/library/rust/shared/Cargo.toml`. |
| 126.0 | midir | 85156e360a37d851734118104619f86bd18e94c6 | This commit is required explicitly by the top level Cargo.toml |
| 126.0 | aa-stroke | d94278ed9c7020f50232689a26d1277eb0eb74d2 | Required explicitly by `./toolkit/library/rust/shared/Cargo.toml`. |
| 126.0 | jsparagus | 61f399c53a641ebd3077c1f39f054f6d396a633c | Required explicitly by `js/src/frontend/smoosh/Cargo.toml`.|
| 126.0 | mio | 9a2ef335c366044ffe73b1c4acabe50a1daefe05 | This commit is required explicitly by the top level Cargo.toml |
| 126.0 | unicode-bidi | ca612daf1c08c53abe07327cb3e6ef6e0a760f0c | Specified in top level Cargo.toml, by explicit hash. |
